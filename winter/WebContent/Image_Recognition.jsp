	...
	<head>
		...
		<script>
			...
			function classifier() {
				...
				var data = {'path': path};
				var jythonURL = "./imageRecognition";
				$.ajax({
					url: jythonURL,
					method: 'post',
					data: data,
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								<h2 class="major">Image Recognition</h2>
								<h4>Intro</h4>
								<p>
                  This model classify which animal is taken a picture with 85% accuracy.  <br/>
                  <span class="image main"><img src="https://i.imgur.com/4jDTLBZ.jpg" alt="Image Recognition Example" /></span>
                  With above picture, this model will classify it as cat.  <br/>
                  ...
                  CNN can improve accuracy of model which handle image data. The reason of improvement is, Fully connected layer only support 1D data and image is 2D data. We need to flatten 2D image to 1D data to use fully connected layer. In this step, spatial information of 2D image is lost. To avoid lost of spatial informations, we use CNN which extract spatial information as feature. So when we use spatial data as input, we can improve accuracy by using CNN
								...
								<p>
									Above picture depict architecture of image recognition model. First layer is input layer which accept user input. Input layer accept user input as [?, 64 * 64] list. Input layer forward this value to CNN layer.<br/><br/>
